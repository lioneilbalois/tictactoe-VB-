...
Partial Class About
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "Report Bugs: ouremail@email.com"
        '
        'Label3
        '
        ...
        Me.Label3.Text = "Tic-Tac-Toe (Multiplayer Offline) is an"
        '
        'Label4
        '
        ...
        Me.Label4.Text = "app that provides 2 game modes of"
        '
        'Label5
        '
        ...
        Me.Label5.Text = "Visit Us: oursite.com"
        '
        'Label6
        '
        ...
        Me.Label6.Text = "playing the known game."
        '
        'Label7
        '
        ...
        Me.Label7.Text = "Tic-Tac-Toe(Multiplayer Offline)"
        '
        'PictureBox1
        '
